...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Editable content for the home page';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    crisisBody: Schema.Attribute.Text;
    crisisImage: Schema.Attribute.Media<'images'>;
    crisisLabel: Schema.Attribute.String;
    crisisQuote: Schema.Attribute.Text;
    crisisSecondaryBody: Schema.Attribute.Text;
    crisisTitle: Schema.Attribute.String;
    heroBannerImage: Schema.Attribute.Media<'images'>;
    heroDescription: Schema.Attribute.Text;
    heroManufacturingImage: Schema.Attribute.Media<'images'>;
    heroPrimaryBtnLink: Schema.Attribute.String;
    heroPrimaryBtnText: Schema.Attribute.String;
    heroScubaDiverImage: Schema.Attribute.Media<'images'>;
    heroSecondaryBtnLink: Schema.Attribute.String;
    heroSecondaryBtnText: Schema.Attribute.String;
    heroSubtitle: Schema.Attribute.String;
    heroTertiaryBtnLink: Schema.Attribute.String;
    heroTertiaryBtnText: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    solutionBody: Schema.Attribute.Text;
    solutionImage: Schema.Attribute.Media<'images'>;
    solutionLabel: Schema.Attribute.String;
    solutionProg1Body: Schema.Attribute.Text;
    solutionProg1Emoji: Schema.Attribute.String;
    solutionProg1Title: Schema.Attribute.String;
    solutionProg2Body: Schema.Attribute.Text;
    solutionProg2Emoji: Schema.Attribute.String;
    solutionProg2Title: Schema.Attribute.String;
    solutionProg3Body: Schema.Attribute.Text;
